...
TokyoRe_verbAudioProcessor::TokyoRe_verbAudioProcessor()
     ...
     : AudioProcessor (BusesProperties()
         ...
         std::make_unique<AudioParameterFloat>("wet", "Wet", 0.0f, 1.0f, 0.4f),
         std::make_unique<AudioParameterFloat>("room", "Room", 0.0f, 1.0f, 0.5f),
         std::make_unique<AudioParameterFloat>("damp", "Damp", 0.0f, 1.0f, 0.5f),
         std::make_unique<AudioParameterFloat>("width", "Width", 0.0f, 1.0f, 0.5f),
...
#endif
{
    ...
    tokyoReverbParameters.dryLevel = 0.5;
    tokyoReverbParameters.wetLevel = 0.5;
    tokyoReverbParameters.roomSize = 0.5;
    tokyoReverbParameters.damping = 0.5;
    tokyoReverbParameters.width = 0.5;
